...
func (siw *ServerInterfaceWrapper) GetProducts(w http.ResponseWriter, r *http.Request) {
	...
	// ------------- Optional query parameter "inStockOnly" -------------

	err = runtime.BindQueryParameter("form", true, false, "inStockOnly", r.URL.Query(), &params.InStockOnly)
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "inStockOnly", Err: err})
		return
	}
